...
export class CategoriesAdminController {
  ...
  @Roles('MANAGER','ADMIN','SUPER_ADMIN') @Post() create(@Body() dto: CreateCategoryDto, @CurrentUser() u: AuthenticatedUser) { return this.service.create(dto, u.id); }
  @Roles('MANAGER','ADMIN','SUPER_ADMIN') @Patch(':id') update(@Param('id') id: string, @Body() dto: UpdateCategoryDto, @CurrentUser() u: AuthenticatedUser) { return this.service.update(id, dto, u.id); }
